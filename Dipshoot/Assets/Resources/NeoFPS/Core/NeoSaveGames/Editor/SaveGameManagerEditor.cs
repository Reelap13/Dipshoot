...
namespace NeoFPSEditor.SaveGames
{
    ...
    public class SaveGameManagerEditor : NeoSerializedSceneEditorBase
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_CurrentVersion"));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("m_MinimumVersion"));
